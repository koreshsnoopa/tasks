...
namespace exceptions_task
{
    public class Transmission
    {
        ...
        public Transmission(string typeOfTransmission, int numberOfGears, string manufacturer)
        {
            ...
            {
                throw new InitializationException("You need to enter type of transmission!");
            }
            else
            {
            ...
            {
                throw new InitializationException("Number of gears must be more then 0!");
            }

            if (String.IsNullOrEmpty(manufacturer))
            {
                throw new InitializationException("You need to enter manufacturer!");
            }
            else
            {
